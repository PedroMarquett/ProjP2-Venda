...
namespace Prova2.Controllers
{
    public class FornecedorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idFornecedor,Nome,Telefone,Email,Estado,CEP,CPNJ")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idFornecedor,Nome,Telefone,Email,Estado,CEP,CPNJ")] Fornecedor fornecedor)
        {
            if (ModelState.IsValid)
            {
